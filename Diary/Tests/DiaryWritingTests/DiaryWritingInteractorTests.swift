...
final class DiaryWritingInteractorTests: XCTestCase {
    ...
    override func setUp() {
        ...
        sut = DiaryWritingInteractor(
            presenter: self.presenter,
            dependency: self.dependency,
            diaryModel: nil,
            page: 0
        )
        sutEditMode = DiaryWritingInteractor(
            presenter: self.presenter,
            dependency: self.dependency,
    ...
    func testWriteDiary() {
        ...
        sut.placeModelRelay.accept(PlaceModelRealm(place: .company, detailText: "bus"))
    ...
    func testWriteDiaryWithTempSave() {
        ...
        let tempSaveDiaryModelRealm = DiaryModelRealm(
            pageNum: 123,
            title: "tempSaveTitle",
            weather: nil,
            place: nil,
